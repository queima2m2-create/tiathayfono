      ...
      <div className="flex flex-col items-center gap-5">
        ...
        <div className="max-w-[520px]">
          ...
          <p className="text-[1rem] md:text-[1.05rem] text-primary/80 leading-[1.7]">
            <strong className="text-marrom-dark">Dra. Thaynara Andrade — a fonoaudióloga que destravou a fala de {getSocialProofCount()} crianças</strong>
            <br /><br />
            Fonoaudióloga infantil (CRFa 4-13693) com mais de 8 anos de experiência e {getSocialProofCount()} famílias atendidas. Vou te mostrar como destravar a fala do seu filho usando 15 min por dia da sua rotina.
          </p>
        </div>
      </div>
    </div>
