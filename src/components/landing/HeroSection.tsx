      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-8 items-center">
        <div>
          <h1 className="text-[1.45rem] md:text-[2.6rem] font-black leading-[1.1] text-marrom-dark mb-2 md:mb-3 uppercase tracking-tight">
            SEU FILHO AINDA NÃO FALA COMO DEVERIA?{" "}
            <span className="text-rosa">DESCUBRA COMO ESTIMULAR A FALA DE FORMA SIMPLES E EFICAZ</span>
          </h1>

          <p className="text-[0.95rem] md:text-[1.05rem] text-primary/80 leading-[1.5] md:leading-[1.8] max-w-[480px] mb-3 md:mb-0">
            Um guia prático criado por uma fonoaudióloga e mãe, que vai te mostrar
            o passo a passo para transformar o dia a dia com seu filho em
        ...
        <div>
          <img
            src={heroImg}
            alt="Mãe estimulando a fala do filho"
