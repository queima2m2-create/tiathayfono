    ...
    <div className="bg-background text-marrom-dark rounded-2xl p-8 md:p-10">
      {showUrgency && (
        <span className="inline-block bg-vermelho text-background text-[0.85rem] font-bold px-6 py-2.5 rounded-lg mb-5">
          ⏰ Condição válida somente até 31/03
        </span>
      )}

      <p className="text-[1rem] mb-1 font-semibold">
        De: <span className="text-[1.3rem] font-bold text-vermelho line-through">R$ 549,00</span>
      </p>
      ...
      <div className="inline-block bg-marrom-dark text-background text-[1.3rem] font-black px-8 py-3 rounded-xl my-4">
        OU R$ 67 NO PIX
      </div>
