const FooterSpain = () => (
  <footer className="bg-rosa text-background/50 text-center py-8 px-6 text-[0.8rem] leading-relaxed">
    <p>© 2025 Thaynara Andrade Logopeda · tiathayfono.com.br · Todos los derechos reservados</p>
    ...
    <p className="mt-5 opacity-50 max-w-[600px] mx-auto">
      ...
      Una vez que sales de Facebook, la responsabilidad no es de ellos sino de nuestro sitio.
    </p>
  </footer>
);
