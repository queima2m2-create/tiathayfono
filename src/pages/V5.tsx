...
import etapa1 from "@/assets/v5-etapa1-cerebro-fala-es.webp";
import etapa2 from "@/assets/v5-etapa2-protocolo-es.webp";
import etapa3 from "@/assets/v5-etapa3-tagarelas-es.webp";
import entregaSinais from "@/assets/v5-entrega-sinais-alerta-es.webp";
import entregaFala from "@/assets/v5-entrega-fala-funciona-es.webp";
import entregaBrincadeiras from "@/assets/v5-entrega-brincadeiras-fala-es.webp";
import entregaPalavras from "@/assets/v5-entrega-palavras-es.webp";
import entregaAtividades from "@/assets/v5-entrega-atividades-es.webp";
import entregaTelas from "@/assets/v5-entrega-telas-es.webp";
import entregaSuporteWpp from "@/assets/v5-entrega-suporte-wpp-es.webp";
import bonusMusicas from "@/assets/v5-bonus-musicas-es.webp";
import bonusAulaVivo from "@/assets/v5-bonus-aula-vivo-es.webp";
import bonusCards from "@/assets/v5-bonus-cards-es.webp";
import bonusCertificado from "@/assets/v5-bonus-certificado-es.webp";
import produtoMockup from "@/assets/v5-producto-mockup-es.webp";
import doisCaminhos from "@/assets/v5-dos-caminos-es.webp";
import thaynaraFoto from "@/assets/thaynara-foto.webp";
import sobreFilha from "@/assets/sobre-filha.webp";
import seloGarantia from "@/assets/v5-sello-garantia-es.webp";
