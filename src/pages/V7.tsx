      ...
      <section className="px-5 py-12 md:py-16 bg-white">
        <div className="max-w-[640px] mx-auto">
          <div
            ...
            style={{ borderColor: ROXO, background: "#FFFDF8" }}
          >
            <p className="text-neutral-500 line-through text-xl md:text-2xl font-semibold mb-1">
              <span style={{ color: "#D32F2F" }}>De R$ 1.997</span>
            </p>
            ...
            {/* GARANTIAS */}
            <div className="mt-7 pt-6 border-t border-neutral-200 space-y-2 text-[0.92rem] text-neutral-600">
